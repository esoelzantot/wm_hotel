...
class RoomsViewMobileLayout extends StatefulWidget {
  const RoomsViewMobileLayout({super.key});

  @override
  State<RoomsViewMobileLayout> createState() => _RoomsViewMobileLayoutState();
}

class _RoomsViewMobileLayoutState extends State<RoomsViewMobileLayout> {
