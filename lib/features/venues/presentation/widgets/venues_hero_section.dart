...
class VenuesHeroSection extends StatefulWidget {
  const VenuesHeroSection({super.key});

  @override
  State<VenuesHeroSection> createState() => _VenuesHeroSectionState();
}

class _VenuesHeroSectionState extends State<VenuesHeroSection> {
  late double width;
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(AppAssets.venuesImg),
            fit: BoxFit.fill,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Title
              Text(
                S.of(context).venues_hero_title,
              ...
              SizedBox(
                width: width * 0.6,
                child: Text(
                  S.of(context).venues_hero_content,
