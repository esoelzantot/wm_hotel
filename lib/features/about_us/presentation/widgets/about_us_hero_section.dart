...
class AboutUsHeroSection extends StatefulWidget {
  ...
  @override
  State<AboutUsHeroSection> createState() => _AboutUsHeroSectionState();
}

class _AboutUsHeroSectionState extends State<AboutUsHeroSection> {
  late double width;
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(AppAssets.aboutUsImg),
            fit: BoxFit.fill,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Title
              Text(
                S.of(context).about_us_hero_title,
              ...
              SizedBox(
                width: width * 0.6,
                child: Text(
                  S.of(context).about_us_hero_content,
