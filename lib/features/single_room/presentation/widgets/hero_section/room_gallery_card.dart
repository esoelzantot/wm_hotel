...
class RoomGalleryCard extends StatefulWidget {
  final List<String> imageUrls;
  final int currentIndex;
  final ValueChanged<int> onPageChanged;

  const RoomGalleryCard({
    super.key,
  ...
  @override
  State<RoomGalleryCard> createState() => _RoomGalleryCardState();
}

class _RoomGalleryCardState extends State<RoomGalleryCard>
  ...
  @override
  void didUpdateWidget(RoomGalleryCard old) {
